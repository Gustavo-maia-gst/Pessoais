...
def _and(self, context):
    self.code.append(f'push rax')
    self.expr(context, PrecedenceOrder.LOG_AND)
    self.code.append(f'pop rbx')
...
def _eq(self, context):
    self.code.append(f'push rax')
    self.expr(context, PrecedenceOrder.RELATION)
    self.code.append(f'pop rbx')
...
def add(self, context):
    self.code.append(f'push rax')
    self.expr(context, PrecedenceOrder.SUM)
    self.code.append(f'pop rbx')
...
def mult(self, context):
    self.code.append(f'push rax')
    self.expr(context, PrecedenceOrder.MULTIPLICATION)
    self.code.append(f'pop rbx')
